/**
 * AppLogo — the circular scrambled-cube badge, mirrored from public/favicon.svg
...
export function AppLogo({ className = "size-8" }: AppLogoProps) {
  return (
    <svg viewBox="0 0 200 200" className={className} aria-hidden="true">
      ...
      <g>
        <path d="M48.038,130 L30.718,120 L30.718,100 L48.038,110 Z" fill="#f97316" fillOpacity="0.4" stroke="#f97316" strokeOpacity="0.55" strokeWidth="1.5" strokeLinejoin="round" />
        <path d="M48.038,110 L30.718,100 L30.718,80 L48.038,90 Z" fill="#f97316" fillOpacity="0.4" stroke="#f97316" strokeOpacity="0.55" strokeWidth="1.5" strokeLinejoin="round" />
        <path d="M48.038,90 L30.718,80 L30.718,60 L48.038,70 Z" fill="#f97316" fillOpacity="0.4" stroke="#f97316" strokeOpacity="0.55" strokeWidth="1.5" strokeLinejoin="round" />
        <path d="M151.962,130 L169.282,120 L169.282,100 L151.962,110 Z" fill="#3b82f6" fillOpacity="0.4" stroke="#3b82f6" strokeOpacity="0.55" strokeWidth="1.5" strokeLinejoin="round" />
        <path d="M151.962,110 L169.282,100 L169.282,80 L151.962,90 Z" fill="#3b82f6" fillOpacity="0.4" stroke="#3b82f6" strokeOpacity="0.55" strokeWidth="1.5" strokeLinejoin="round" />
        <path d="M151.962,90 L169.282,80 L169.282,60 L151.962,70 Z" fill="#3b82f6" fillOpacity="0.4" stroke="#3b82f6" strokeOpacity="0.55" strokeWidth="1.5" strokeLinejoin="round" />
      </g>
      ...
      <g>
        ...
        <path d="M134.641,80 L151.962,70 L134.641,60 L117.321,70 Z" fill="#22c55e" stroke="#05070d" strokeWidth="2" strokeLinejoin="round" />
        ...
        <path d="M65.359,80 L82.679,70 L65.359,60 L48.038,70 Z" fill="#f97316" stroke="#05070d" strokeWidth="2" strokeLinejoin="round" />
        ...
        <path d="M65.359,140 L48.038,130 L48.038,110 L65.359,120 Z" fill="#f8fafc" stroke="#05070d" strokeWidth="2" strokeLinejoin="round" />
        ...
        <path d="M100,120 L82.679,110 L82.679,90 L100,100 Z" fill="#ef4444" stroke="#05070d" strokeWidth="2" strokeLinejoin="round" />
        ...
        <path d="M117.321,150 L134.641,140 L134.641,120 L117.321,130 Z" fill="#f97316" stroke="#05070d" strokeWidth="2" strokeLinejoin="round" />
        ...
        <path d="M134.641,120 L151.962,110 L151.962,90 L134.641,100 Z" fill="#eab308" stroke="#05070d" strokeWidth="2" strokeLinejoin="round" />
        ...
        <path d="M134.641,100 L151.962,90 L151.962,70 L134.641,80 Z" fill="#3b82f6" stroke="#05070d" strokeWidth="2" strokeLinejoin="round" />
      </g>
    </svg>
  );
}
