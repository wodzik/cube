    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 backdrop-blur-sm p-4" onClick={onClose}>
      ...
      >
        <div className="flex items-center justify-between px-5 py-4 border-b border-white/[0.06] shrink-0">
          <h2 className="text-white font-semibold text-base">{subgroup ? t("subgroup.settings") : t("subgroup.new")}</h2>
        ...
        <div className="flex-1 overflow-y-auto p-5 space-y-4">
          <div>
            ...
            <input
              ...
              placeholder={t("subgroupModal.namePlaceholder")}
          ...
          <div>
            ...
            <input
              ...
              placeholder={t("subgroupModal.previewPlaceholder")}
              className={`${inputClass} font-mono`}
            />
            <p className="text-[11px] text-gray-600 mt-1">{t("subgroupModal.previewHint")}</p>
          </div>
        ...
        <div className="flex items-center justify-between gap-2 px-5 py-4 border-t border-white/[0.06] shrink-0">
          <div>
            {onDelete && (
              ...
              >
                <Trash2 size={14} /> {confirmDelete ? t("common.clickToDelete") : t("subgroupModal.delete")}
              </button>
            )}
          </div>
