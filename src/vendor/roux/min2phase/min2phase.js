...
// VENDORING CHANGE (nact): CommonJS exports replaced with ESM so Vite can
// serve this file to the browser (bun's CJS interop masked the difference).
export { initialize, solve, randomCube };
