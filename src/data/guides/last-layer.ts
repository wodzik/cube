  ...
  sections: [
    ...
    },
    {
      ...
      blocks: [
        ...
        { kind: "p", text: "Three of the cases are the same idea: an `F`, then the sexy move one, two or three times, then `F'`. Two are blocks **A** (sexy move + sledgehammer) and **B** — the ones look 3 reuses, so learn them cold. The last two are the well-known Sune and Antisune." },
        {
          kind: "cases",
          cases: [
            ...
            solveCase("co-a", "Two done · opposite ways", "Two corners have yellow up. The other two are next to each other, but one yellow sticker points at you and the other away from you.", "Those two corners on the left, the one pointing at you at the front.", CO("block-a"), "ll-corners-orient", { note: "Algorithm A — a sexy move followed by a sledgehammer. Remember it: you'll use it again later." }),
            solveCase("co-b", "Two done · diagonal", "Two corners have yellow up, and they're diagonally opposite each other.", "A twisted corner at the front-left with its yellow facing you; the other twisted corner is then at the back-right with its yellow facing right.", CO("block-b"), "ll-corners-orient", { note: "Algorithm B. Remember it too: you'll use it again later." }),
